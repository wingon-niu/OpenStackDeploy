...
NODE_HOST_NAME=kh-01
NODE_HOST_NAME_FQDN=kh-01.com

#Used for all keepalived nodes, set different value on each node
KEEPALIVED_ROUTER_ID=ka160
KEEPALIVED_INTERNAL_NET_PRIORITY=160
KEEPALIVED_EXTERNAL_NET_PRIORITY=160
...
KEEPALIVED_INTERNAL_NET_INTERFACE_NAME=eth1
KEEPALIVED_EXTERNAL_NET_INTERFACE_NAME=eth0
...
CONTROLLER_NODE_01_INTERNAL_IP=10.10.20.12
CONTROLLER_NODE_02_INTERNAL_IP=10.10.20.13
CONTROLLER_NODE_03_INTERNAL_IP=10.10.20.14
