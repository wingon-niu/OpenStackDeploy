...
echo "Begin time of haproxy-keepalived-node-install:"
date
...
echo "    bind    $KEEPALIVED_INTERNAL_NET_VIRTUAL_IP:3306"                                         >> $CONF_FILE
...
echo "    bind    $KEEPALIVED_INTERNAL_NET_VIRTUAL_IP:35357"                                        >> $CONF_FILE
echo "    balance source"                                                                           >> $CONF_FILE
echo "    mode    tcp"                                                                              >> $CONF_FILE
echo "    option  tcplog"                                                                           >> $CONF_FILE
echo "    option  tcpka"                                                                            >> $CONF_FILE
...
echo "End time of haproxy-keepalived-node-install:"
date
