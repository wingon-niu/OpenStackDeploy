...
./set-config.py $conf_file_03 keystone_authtoken  admin_user               glance
./set-config.py $conf_file_03 keystone_authtoken  admin_password           $KEYSTONE_SERVICE_PASSWORD
...
./set-config.py $conf_file_04 keystone_authtoken  admin_user               glance
./set-config.py $conf_file_04 keystone_authtoken  admin_password           $KEYSTONE_SERVICE_PASSWORD
